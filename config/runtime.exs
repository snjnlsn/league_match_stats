...
#
#     PHX_SERVER=true bin/league_match_stats start
#
...
if config_env() == :prod do
  ...
  config :league_match_stats, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :league_match_stats, LeagueMatchStats.Mailer,
